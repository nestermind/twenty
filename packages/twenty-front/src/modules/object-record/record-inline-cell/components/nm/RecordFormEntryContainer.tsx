...
import { RecordFormEntryValue } from '@/object-record/record-inline-cell/components/nm/RecordFormEntryValue';
...
export const RecordFormEntryContainer = () => {
  const {
    readonly,
    IconLabel,
    label,
